...
For additional configurations for the source models, please visit the [Twitter Ads Analytics source package](https://github.com/fivetran/dbt_twitter_source).
